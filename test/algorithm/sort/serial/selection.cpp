 ...
 *
 * Status: DEBUGGED - date : Mar 11 2021
 *
...
int main(int argc ,char* argv[])
{
  ...
  po::options_description test("Options for serial selection algorithm");
  test.add_options()
    ("help,h", "Show help.")
  ...
  time.stop();
  time.report("Elapsed time (selection sorting algorithm)");
